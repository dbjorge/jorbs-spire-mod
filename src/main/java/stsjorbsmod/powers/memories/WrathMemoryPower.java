...
public class WrathMemoryPower extends AbstractMemoryPower implements CloneablePowerInterface {
    private static final int DAMAGE_INCREASE_PER_KILL = 1;

    public static final String POWER_ID = JorbsMod.makeID(WrathMemoryPower.class.getSimpleName());
