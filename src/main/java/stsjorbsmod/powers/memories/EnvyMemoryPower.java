...
public class EnvyMemoryPower extends AbstractMemoryPower implements CloneablePowerInterface {
    private static final int VULNERABLE_ON_REMEMBER = 1;
    private static final int VULNERABLE_ON_TARGET_ENEMY = 1;

    public static final String POWER_ID = JorbsMod.makeID(EnvyMemoryPower.class.getSimpleName());
