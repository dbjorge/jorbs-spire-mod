...
public class HumilityMemoryPower extends AbstractMemoryPower implements CloneablePowerInterface {
    private static final int THORNS_DAMAGE = 2;

    public static final String POWER_ID = JorbsMod.makeID(HumilityMemoryPower.class.getSimpleName());
