...
Material Components Deck:	Contains 7 common, 6 uncommon, 3 rare Material Components cards.
    ...
    Forbidden Grimoire+	Entomb. Returns to your hand at start of turn 7.
	0: Choose 1 of 3 cards from Material Components deck. Exhaust. Return this to Hand after you play two cards unless you are Snapped.

	Book of Tongues	(Power) 1: At the start of your turn add a random card from the Material Components deck to your hand
 */
